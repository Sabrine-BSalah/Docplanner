...
import './App.css';
import HeaderDoc from './Components/Header/header-doc'
import IntroTitleDoc from './Components/Intro-title/intro-title-doc'
import IntroTextDoc from './Components/Intro-text/intro-text-doc'
import ServicesDoc from './Components/Services-doc/services-doc'
import Brands from './Components/Brands/brands'
import StatsIntro from './Components/stats-intro/stats-intro'
import StatsCards from './Components/stats-cards/stats-card'
import OfficesIntro from './Components/offices-intro/offices-intro'
import OfficesCard from './Components/offices-list/offices-card'
import Footer from './Components/footer/footer'


const navmenu= [
{name: "About us", url: "https://www.docplanner.com/about-us", class: "active-link"},
{name: "Career", url: "https://www.docplanner.com/career"},
{name: "Departments", class: "dropdown-link", drop: [
  {name: "Marketing & PR", url: "https://www.docplanner.com/department?dep=marketing"},
  {name: "Customer Success & Sales", url: "https://www.docplanner.com/department?dep=customer"},
  {name: "IT, Product, Design & UX", url: "https://www.docplanner.com/department?dep=it"},
  {name: "Finance & Administration", url: "https://www.docplanner.com/department?dep=finance"},
  {name: "HR & more", url:"https://www.docplanner.com/department?dep=hr"}
]}
]
...
const services= [
  { for: "For patients",
    ...
    country: ["CHOOSE COUNTRY","ARGENTINA","AUSTRALIA","BRAZIL","CHILE","COLOMBIA","CZECH","FRANCE","ITALY","MEXICO","PERU","POLAND","PORTUGAL","SPAIN","TURKEY","UK"],
...
const cards= [
  {class: "stat-card", image: "https://www.docplanner.com/img/flag.png", title:"Leader in 10 countries", details:"Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil, Colombia, Argentina and Chile"},
  {class: "stat-card appointement-card", image: "https://www.docplanner.com/img/visits.png", title:"1.5 million appointments", details:"booked last month"},
  {class: "stat-card", image: "https://www.docplanner.com/img/patients.png", title:"30 million unique patients", details:"visit us every month"},
  {class: "stat-card doctors-card", image: "https://www.docplanner.com/img/doctors.png", title:"2 million active doctors", details:"trust in our solutions"},
]

const offices= [
  { url: "https://www.docplanner.com/career?&loc=poland#jobs-offers",
    img: "https://www.docplanner.com/images/warsaw.png",
    src: "https://www.docplanner.com/images/warsaw.png 1x, https://www.docplanner.com/images/warsaw@2x.png 2x",
    desc: "Warsaw"
  },
  { url: "https://www.docplanner.com/career?&loc=spain#jobs-offers",
    img: "https://www.docplanner.com/images/barcelona.png",
    src: "https://www.docplanner.com/images/barcelona.png 1x, https://www.docplanner.com/images/barcelona@2x.png 2x",
    desc: "Barcelona"
  },
  { url: "https://www.docplanner.com/career?&loc=rome#jobs-offers",
    img: "https://www.docplanner.com/images/istanbul.png",
    src: "https://www.docplanner.com/images/istanbul.png 1x, https://www.docplanner.com/images/istanbul@2x.png 2x",
    desc: "Istanbul"
  },
  { url: "https://www.docplanner.com/career?&loc=italy#jobs-offers",
    img: "https://www.docplanner.com/images/rome.png",
    src: "https://www.docplanner.com/images/rome.png 1x, https://www.docplanner.com/images/rome@2x.png 2x",
    desc: "Rome"
  },
  { url: "https://www.docplanner.com/career?&loc=mexico#jobs-offers",
    img: "https://www.docplanner.com/images/mexico-city.png",
    src: "https://www.docplanner.com/images/mexico-city.png 1x, https://www.docplanner.com/images/mexico-city@2x.png 2x",
    desc: "Mexico city"
  },
  { url: "https://www.docplanner.com/career?&loc=brazil#jobs-offers",
    img: "https://www.docplanner.com/images/curitiba.png",
    src: "https://www.docplanner.com/images/curitiba.png 1x, https://www.docplanner.com/images/curitiba@2x.png 2x",
    desc: "Curitiba"
  }
]

const leaders= [
  {url: "https://www.znanylekarz.pl/?_ga=2.75572693.1705352721.1573375722-274087.1573215103", country:"Poland"},
  {url: "https://www.doktortakvimi.com/?_ga=2.116477382.1705352721.1573375722-274087.1573215103", country:"Turkey"},
  {url: "https://www.doctoralia.es/", country:"Spain"},
  {url: "https://www.miodottore.it/?_ga=2.116477382.1705352721.1573375722-274087.1573215103", country:"Italy"},
  {url: "https://www.znamylekar.cz/", country:"Czech Republic"},
  {url: "https://www.doctoralia.com.mx/", country:"Mexico"},
  {url: "https://www.doctoralia.co/", country:"Colombia"},
  {url: "https://www.doctoralia.com.br/", country:"Brazil"},
  {url: "https://www.doctoraliar.com/", country:"Argentina"},
  {url: "https://www.doctoralia.cl/", country:"Chile"}
]
    ...
    <div className="App">
      ...
      <main>
        <div className="intro-section">
          <IntroTitleDoc />
          <IntroTextDoc y={parags}/>
        </div>
        <ServicesDoc z={services} />
        <Brands a={brands} />
